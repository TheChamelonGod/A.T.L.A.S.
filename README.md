...
Add a -mwindows at the end to compile without the command promt.
...
To use the Slack PAR bot, go to https://api.slack.com/apps and create a new app, and press create from scratch. Select a worksapc, choose the one you use the most. Once you made the app, locate incoming webhooks and enable active incoming webhooks. Add a new webhook, select yourself for the channel webhook and done! (I dont actually want to make a bot so I'm making you do it if you want it)
