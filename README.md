...
ill add comments to explain evrything tmmrw if i have time -_-, however, if ive coded well, u should be able to follow along relativitley well if its antyhing else than the gui, i myself dont understand what ive done to make my code spaghetti like that.